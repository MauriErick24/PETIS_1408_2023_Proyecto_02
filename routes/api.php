...
Route::get('distintosO/{distinto}', [OrganizadorController::class, 'distintos']);
Route::get('distintosP/{distinto}', [PremioController::class, 'distintos']);
Route::get('distintosPA/{distinto}', [PremioController::class, 'distintosP']);
Route::get('distintosA/{distinto}', [AuspiciadorController::class, 'distintos']);
Route::get('distintosAA/{distinto}', [AuspiciadorController::class, 'distintosAgregar']);
Route::get('asignarComunicado', [ComunicadoController::class, 'cantDatos']);
Route::post('quitarAuspiciadores', [AuspiciadorController::class, 'desAsignarAuspiciador']);
Route::post('asignarAuspiciador', [AuspiciadorController::class, 'asignarAuspiciador']);
Route::post('asignarPremios', [PremioController::class, 'asignarPremio']);
Route::post('asignarActividades', [ActividadController::class, 'asignarActividades']);
Route::get('cantOrganizadores', [OrganizadorController::class, 'cantDatos']);
Route::get('cantAuspiciadores', [AuspiciadorController::class, 'cantDatos']);
Route::get('cantActividades', [ActividadController::class, 'cantDatos']);
Route::get('cantPremios', [PremioController::class, 'cantDatos']);
